package org.xtext.example.mydsl.debug.core.pda;
...
public class DebugCorePlugin extends Plugin {
    ...
    public static final String ATTR_PDA_ARG_VALUE = ID_PDA_DEBUG_MODEL + ".ATTR_PDA_ARG_VALUE";
     ...
     * Plug-in identifier.
     */
    public static final String PLUGIN_ID = "org.xtext.example.mydsl.debug.core.pda"; //$NON-NLS-1$
